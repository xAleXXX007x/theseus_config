...
var stagedItems as IIngredient[][string] = {
    [INF_1]:[
        ...
        <refinedstorage:storage_disk>.withTag({IdLeast: -5765043228184033397 as long, IdMost: 7304783092916896529 as long}),
        <refinedstorage:storage_disk:1>.withTag({IdLeast: -4798450498858178333 as long, IdMost: 8981835802234144570 as long}),
        <refinedstorage:storage_disk:2>.withTag({IdLeast: -8520936726811554191 as long, IdMost: 8471233835779245879 as long}),
        <refinedstorage:storage_disk:3>.withTag({IdLeast: -4784538315815775302 as long, IdMost: 5984190755500148382 as long}),
        <refinedstorage:fluid_storage_disk>.withTag({IdLeast: -6286381835624693766 as long, IdMost: 938106131958221125 as long}),
        <refinedstorage:fluid_storage_disk:1>.withTag({IdLeast: -6671476887766868290 as long, IdMost: 585241537953809687 as long}),
        <refinedstorage:fluid_storage_disk:2>.withTag({IdLeast: -5840737159745722803 as long, IdMost: 3006293969240737802 as long}),
        <refinedstorage:fluid_storage_disk:3>.withTag({IdLeast: -6699397805654254082 as long, IdMost: -3356792979504676750 as long}),
