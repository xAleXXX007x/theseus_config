...
GunStats.setWeaponStat("rocketlauncher", "DAMAGE_DROP_START", 5);
...
GunStats.setWeaponStat("pulserifle", "DAMAGE_DROP_START", 15);
...
GunStats.setWeaponStat("blasterrifle", "DAMAGE_DROP_START", 15);
...
GunStats.setWeaponStat("netherblaster", "DAMAGE_DROP_START", 5);
...
GunStats.setWeaponStat("aug", "DAMAGE_DROP_START", 15);
...
GunStats.setWeaponStat("chainsaw", "DAMAGE_DROP_START", 3);
...
GunStats.setWeaponStat("nucleardeathray", "DAMAGE_DROP_START", 10);
...
GunStats.setWeaponStat("mibgun", "DAMAGE_DROP_START", 15);
...
GunStats.setWeaponStat("scar", "DAMAGE_DROP_START", 20);
...
GunStats.setWeaponStat("guidedmissilelauncher", "DAMAGE", 4);
GunStats.setWeaponStat("guidedmissilelauncher", "DAMAGE_MIN", 1);
